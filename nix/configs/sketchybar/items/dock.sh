...
sketchybar --add item seperator.l2 center \
...
sketchybar --add item terminal center \
...
sketchybar --add item vscode center \
	--set vscode "${vscode[@]}"
...
sketchybar --add item finder center \
	--set finder "${finder[@]}"
...
sketchybar --add item browser center \
	--set browser "${browser[@]}"
...
sketchybar --add item settings center \
	--set settings "${settings[@]}"

sketchybar --add item seperator.l3 center \
