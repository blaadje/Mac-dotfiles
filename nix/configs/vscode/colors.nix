{ config }: {
  ...
  "editor.tokenColorCustomizations" = {
    comments = "#${config.colorScheme.palette.base03}";
    variables = "#${config.colorScheme.palette.base08}";
    strings = "#${config.colorScheme.palette.base0B}";
    keywords = "#${config.colorScheme.palette.base0E}";
    functions = "#${config.colorScheme.palette.base0D}";
    numbers = "#${config.colorScheme.palette.base09}";
    types = "#${config.colorScheme.palette.base0C}";
    textMateRules = [
      {
      ...
      }
      {
        ...
        settings = { foreground = "#${config.colorScheme.palette.base08}"; };
      }
      {
        scope = [ "variable.other.object.property" ];
        settings = { foreground = "#${config.colorScheme.palette.base0D}"; };
      }
      {
        scope = [ "constant.other.color" ];
        settings = { foreground = "#${config.colorScheme.palette.base0B}"; };
      }
      {
      ...
      }
      {
        ...
        settings = { foreground = "#${config.colorScheme.palette.base0F}"; };
      }
      {
        scope = [
          "keyword"
        ...
        settings = { foreground = "#${config.colorScheme.palette.base0E}"; };
      }
      {
        scope = [
          "keyword.control"
      ...
      }
      {
        ...
        settings = { foreground = "#${config.colorScheme.palette.base0C}"; };
      }
      {
      ...
      }
      {
        ...
        settings = { foreground = "#${config.colorScheme.palette.base09}"; };
      }
      {
        scope = [
          "string"
      ...
      }
      {
        ...
        settings = { foreground = "#${config.colorScheme.palette.base0A}"; };
      }
      {
        scope = [
          "storage.type"
      ...
      # Ajoutez d'autres configurations textMateRules ici
    ];
  };
}
